// Resolve the agnz data directory consistently across the MCP server
...
//
// Resolution order:
//   1. $AGNZ_DATA_DIR — explicit override (used by tests)
//   2. $XDG_DATA_HOME/agnz — proper XDG layout if set
//   3. ~/.local/share/agnz — XDG default on Linux/macOS
...
export function resolveDataDir() {
  ...
  if (process.env.XDG_DATA_HOME) {
    return resolve(process.env.XDG_DATA_HOME, "agnz");
  }
  return resolve(homedir(), ".local", "share", "agnz");
}
