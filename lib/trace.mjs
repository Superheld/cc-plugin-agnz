...
//   turn_start    — emitted before every LLM API call: current system prompt + open files
//   file_opened   — emitted by Read when a file enters the workspace
//   file_closed   — emitted by Close when a file leaves the workspace
//
// This gives a complete chronological picture of what the agent knew and
// how its working-memory changed — the transcript alone only shows the final
// state, not the evolution.
