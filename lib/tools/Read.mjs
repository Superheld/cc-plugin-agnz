...
export default {
  name: "Read",
  description:
    "Read a UTF-8 text file inside the agent's sandbox. Returns the file contents with line numbers prepended and a header showing the total line count (e.g. 'lines 1-50 of 200'). Use start_line/end_line to read a slice of large files.",
  parameters: {
    type: "object",
    properties: {
      path: {
