...
export default {
  name: "LS",
  description:
    "List directory contents. Each line: 'd path' for dirs, 'f path size' for files.",
  parameters: {
    type: "object",
    properties: {
      path: {
        type: "string",
        description: "Directory to list. Use '.' for the sandbox root.",
      },
      depth: {
        type: "integer",
        description: "Levels to recurse (1–5). Default 1.",
        minimum: 1,
        maximum: 5,
        default: 1,
      },
