...
export default {
  name: "Edit",
  description:
    "Edit a file inside the agent's sandbox by replacing an exact string. The old_string must appear exactly once in the file, unless replace_all is true. Preserves file encoding (UTF-8). If old_string is not found, re-read the file with Read to get the current content before retrying — do not retry with the same string.",
  parameters: {
    type: "object",
    properties: {
      path: {
