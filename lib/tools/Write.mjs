...
export default {
  name: "Write",
  description:
    "Create a new file inside the agent's sandbox, or overwrite an existing one (only if overwrite=true). Parent directories are created automatically. Use Edit for partial changes to existing files.",
  parameters: {
    type: "object",
    properties: {
      path: {
