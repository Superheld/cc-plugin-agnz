...
/**
 * Default tiered policy: reads are free within the sandbox, writes need
 * approval, shell requires confirmation.
 */
export function defaultPolicy() {
  return {
    ...
    AskUser: Decision.ALLOW, // intercepted by loop, never reaches policy check
...
export function createSandbox({ root, policy } = {}) {
   ...
   * approves or denies a pending call — optionally for the rest of the thread.
   */
