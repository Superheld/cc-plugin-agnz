...
// *tiny* subset of YAML here — enough for the CC-compatible agent-def
// shape and no more. Bringing in a full YAML parser would violate the
// zero-deps rule of the plugin.
//
...
/**
 * List every *.md under <cwd>/.claude/agnz/agents/ that parses and
 * validates successfully. Returns [] if the directory does not exist.
 */
